...
export function AboutContentModal({ isOpen, onClose, content, onSave }: AboutContentModalProps) {
        ...
        <div className="flex items-center justify-between p-4 border-b border-gray-100">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">
              Update the about section content and settings
            </p>
          </div>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-gray-500">
              {formData.isActive ? 'Section is active and visible on the website' : 'Section is inactive and hidden from the website'}
            </p>
          </div>
        </div>
