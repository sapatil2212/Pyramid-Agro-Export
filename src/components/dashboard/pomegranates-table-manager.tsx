...
interface PomegranatesTableData {
  tableTitle?: string
...
export function PomegranatesTableManager() {
  const [tableData, setTableData] = useState<PomegranatesTableData>({})
  ...
  const defaultVarieties: Variety[] = [
    {
      name: "Bhagwa",
      type: "Deep Red",
      characteristics: "Premium variety with deep red arils and high juice content",
      features: "Deep red arils, High juice content, Premium quality"
    },
    {
      name: "Ganesh",
      type: "Light Red",
      characteristics: "Sweet variety with light red arils and excellent taste",
      features: "Sweet taste, Light red arils, Excellent quality"
    },
    {
      name: "Arakta",
      type: "Dark Red",
      characteristics: "High-yielding variety with dark red arils and good storage life",
      features: "High yield, Dark red arils, Good storage"
    }
  ]

  const defaultSpecifications: Specification[] = [
    { category: "Origin", value: "Nashik, Maharashtra, India" },
    { category: "Varieties", value: "Bhagwa, Ganesh, Arakta" },
    { category: "Size", value: "200-300g per fruit" },
    { category: "Color", value: "Deep Red" },
    { category: "Juice Content", value: "60-65%" },
    { category: "TSS", value: "16-18 Brix" },
    { category: "Acidity", value: "0.3-0.5%" },
    { category: "Aril Color", value: "Deep Red" },
    { category: "Season", value: "September - January" },
    { category: "Quality Grade", value: "Export Grade" }
  ]

  const defaultAdvantages = [
    "Deep red arils with high juice content and excellent visual appeal",
    "Premium quality Bhagwa variety known for superior taste and appearance",
    "Long shelf life of 2-3 months under proper storage conditions",
    "High nutritional value with rich antioxidants and Vitamin C",
    "APEDA certified and meets international quality standards",
    "Perfect for both fresh consumption and juice extraction"
  ]
  ...
  const fetchTableData = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products?slug=pomegranates')
      if (response.ok) {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch('/api/products/pomegranates-table-content', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button
                  onClick={() => window.open('/products/pomegranates', '_blank')}
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-gray-900 line-clamp-2">
                {tableData.tableTitle || "POMEGRANATES - Premium Export Quality"}
              </h4>
              <p className="text-xs text-gray-600 line-clamp-3">
                {tableData.tableDescription || "Premium quality pomegranates with deep red arils, high juice content, and long storage capacity. Perfect for export markets with superior quality and taste."}
              </p>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {editingSection === 'varieties' && 'Edit Pomegranate Varieties'}
      ...
      <SuccessModal
        ...
        message="Your Pomegranates table content has been saved successfully."
      />
    </div>
  )
}
