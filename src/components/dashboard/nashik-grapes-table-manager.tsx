...
export function NashikGrapesTableManager() {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch('/api/products/table-content', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button
                  onClick={() => window.open('/products/grapes', '_blank')}
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {editingSection === 'varieties' && 'Edit Grape Varieties'}
      ...
      <SuccessModal
        ...
        message="Your Nashik Grapes table content has been saved successfully."
      />
    </div>
  )
}
