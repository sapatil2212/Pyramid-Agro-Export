...
export function BananaTableManager() {
  const [tableData, setTableData] = useState<BananaTableData>({})
  ...
  const defaultVarieties: Variety[] = [
    {
      name: "Nendran",
      type: "Cooking Banana",
      characteristics: "Premium variety perfect for cooking with firm texture and excellent taste",
      features: "Firm texture, Cooking variety, Excellent taste"
    },
    {
      name: "Robusta",
      type: "Dessert Banana",
      characteristics: "Sweet variety with soft texture, perfect for fresh consumption",
      features: "Sweet taste, Soft texture, Fresh consumption"
    },
    {
      name: "Grand Nain",
      type: "Export Grade",
      characteristics: "High-yielding variety with uniform size and excellent transport resilience",
      features: "High yield, Uniform size, Transport resilient"
    }
  ]

  const defaultSpecifications: Specification[] = [
    { category: "Origin", value: "Kerala, Tamil Nadu, India" },
    { category: "Varieties", value: "Nendran, Robusta, Grand Nain" },
    { category: "Size", value: "15-20cm length" },
    { category: "Color", value: "Green (Pre-ripening stage)" },
    { category: "Maturity", value: "Pre-ripening stage" },
    { category: "Texture", value: "Firm and starchy" },
    { category: "Weight", value: "150-200g per piece" },
    { category: "Shelf Life", value: "2-3 weeks" },
    { category: "Season", value: "Year Round" },
    { category: "Quality Grade", value: "Export Grade" }
  ]

  const defaultAdvantages = [
    "Rich in nutrients with high potassium and Vitamin C content",
    "Export grade quality with excellent transport resilience",
    "Fresh harvest ensuring maximum nutritional value and taste",
    "Quality assured with rigorous quality checks and standards",
    "Long shelf life of 2-3 weeks under proper storage conditions",
    "Perfect for both cooking and fresh consumption applications"
  ]
  ...
  const fetchTableData = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products?slug=banana')
      if (response.ok) {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch('/api/products/banana-table-content', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button
                  onClick={() => window.open('/products/banana', '_blank')}
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-gray-900 line-clamp-2">
                {tableData.tableTitle || "GREEN BANANAS - Premium Export Quality"}
              </h4>
              <p className="text-xs text-gray-600 line-clamp-3">
                {tableData.tableDescription || "Premium green bananas perfect for cooking and export, maintaining freshness and nutritional value. Harvested at the right maturity stage to ensure firm texture and longer shelf life."}
              </p>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {editingSection === 'varieties' && 'Edit Banana Varieties'}
      ...
      <SuccessModal
        ...
        message="Your Green Bananas table content has been saved successfully."
      />
    </div>
  )
}
