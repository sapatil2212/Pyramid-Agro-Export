...
interface NashikOnionsTableData {
  tableTitle?: string
...
export function NashikOnionsTableManager() {
  const [tableData, setTableData] = useState<NashikOnionsTableData>({})
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch('/api/products/onions-table-content', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button
                  onClick={() => window.open('/products/onions', '_blank')}
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-gray-900 line-clamp-2">
                {tableData.tableTitle || "NASHIK ONIONS - Premium Export Quality"}
              </h4>
              <p className="text-xs text-gray-600 line-clamp-3">
                {tableData.tableDescription || "Nashik onions are renowned worldwide for their strong flavor, firm texture, and uniform grading. With year-round availability and extended shelf life, they are perfect for both food service and retail applications."}
              </p>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {editingSection === 'varieties' && 'Edit Onion Varieties'}
      ...
      <SuccessModal
        ...
        message="Your Nashik Onions table content has been saved successfully."
      />
    </div>
  )
}
