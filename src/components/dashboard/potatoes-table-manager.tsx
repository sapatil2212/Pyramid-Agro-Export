...
export function PotatoesTableManager() {
  const [tableData, setTableData] = useState<PotatoesTableData>({})
  ...
  const defaultVarieties: Variety[] = [
    {
      name: "Premium Grade",
      type: "Export Quality",
      characteristics: "Premium quality potatoes with excellent characteristics",
      features: "Premium quality, Export grade, Excellent characteristics"
    },
    {
      name: "Standard Grade",
      type: "Commercial Quality",
      characteristics: "Standard quality potatoes for commercial use",
  ...
  const defaultAdvantages = [
    "Premium quality potatoes with excellent characteristics",
  ...
  const fetchTableData = async () => {
    try {
      setLoading(true)
      const response = await fetch('/api/products?slug=potatoes')
      if (response.ok) {
  ...
  const handleSave = async () => {
    try {
      ...
      const response = await fetch('/api/products/potatoes-table-content', {
        method: 'PUT',
        headers: {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-4">
          ...
          <div className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <div className="flex items-center space-x-1">
                ...
                <button
                  onClick={() => window.open('/products/potatoes', '_blank')}
            ...
            <div className="space-y-3">
              <h4 className="text-sm font-semibold text-gray-900 line-clamp-2">
                {tableData.tableTitle || "POTATOES - Premium Export Quality"}
              </h4>
              <p className="text-xs text-gray-600 line-clamp-3">
                {tableData.tableDescription || "Premium quality potatoes with excellent characteristics and export grade quality."}
              </p>
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>
              ...
              {editingSection === 'varieties' && 'Edit Potatoes Varieties'}
      ...
      <SuccessModal
        ...
        message="Your Potatoes table content has been saved successfully."
      />
    </div>
  )
}