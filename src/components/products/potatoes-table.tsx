...
const varieties = [
  {
    name: "Jyoti",
    type: "Culinary",
    characteristics: "Starch-rich potatoes with high dry matter content, perfect for chips and fries",
    features: "Starch-rich, High dry matter, Chips, Fries"
  },
  {
    name: "Kufri Bahar",
    type: "Culinary",
    characteristics: "Premium variety with excellent cooking quality and uniform size",
    features: "Cooking quality, Uniform size, Premium, Export grade"
  },
  {
    name: "Kufri Pukhraj",
    type: "Culinary",
    characteristics: "High-quality potatoes with good storage life and cooking properties",
    features: "Storage life, Cooking properties, Quality, Reliable"
  }
]

const specifications = [
  { category: "Origin", value: "India" },
  { category: "Varieties", value: "Jyoti, Kufri Bahar, Kufri Pukhraj" },
  { category: "Quality Grade", value: "Export Grade" },
  { category: "Applications", value: "Chips, fries, culinary cooking" },
  { category: "Dry Matter", value: "High dry matter content" },
  { category: "Starch Content", value: "Starch-rich for industrial use" },
  { category: "Grading", value: "Well-graded and damage-free" },
  { category: "Storage", value: "Good storage life" },
  { category: "Supply", value: "Bulk supply with uniform quality" },
  { category: "Markets", value: "Popular in Middle East" }
]

const keyAdvantages = [
  "High dry matter content, ideal for chips and fries",
  "Bulk supply with uniform quality across large shipments",
  "Popular in the Middle East due to reliability and cooking quality",
  "Starch-rich, damage-free, and well-graded for industrial and retail consumption",
  "Excellent cooking properties with consistent quality",
  "Reliable supply chain for bulk exports"
]

export default function PotatoesTable() {
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center justify-center">
          ...
          POTATOES - Premium Export Quality
        </h2>
        <p className="text-base text-gray-600 max-w-4xl mx-auto">
          Our potatoes are starch-rich, damage-free, and well-graded, making them perfect 
          for industrial and retail consumption with excellent cooking properties.
        </p>
      </div>
