...
const varieties = [
  {
    name: "Salem",
    type: "Premium",
    characteristics: "High curcumin content (3-5%) with excellent color and medicinal properties",
    features: "High curcumin, Color, Medicinal, Premium quality"
  },
  {
    name: "Nizamabad",
    type: "Standard",
    characteristics: "Good curcumin content (2-4%) with consistent quality and aroma",
    features: "Good curcumin, Consistent, Aroma, Standard grade"
  },
  {
    name: "Rajapuri",
    type: "Premium",
    characteristics: "Premium variety with high curcumin content (3-5%) and strong aroma",
    features: "High curcumin, Strong aroma, Premium, Export grade"
  }
]

const specifications = [
  { category: "Origin", value: "India" },
  { category: "Varieties", value: "Salem, Nizamabad, Rajapuri" },
  { category: "Curcumin Content", value: "2–5%" },
  { category: "Applications", value: "Food, pharmaceuticals, dye industry" },
  { category: "Drying Methods", value: "Sun-dried and mechanically dried forms" },
  { category: "Quality Grade", value: "Export Grade" },
  { category: "Color", value: "Bright yellow to deep orange" },
  { category: "Aroma", value: "Strong characteristic turmeric aroma" },
  { category: "Medicinal Value", value: "High curcumin content boosts medicinal properties" },
  { category: "Markets", value: "Dubai & UAE pharmaceutical and spice markets" }
]

const keyAdvantages = [
  "High curcumin content boosts color and medicinal value",
  "Offered in both sun-dried and mechanically dried forms",
  "Strong demand in Dubai & UAE pharmaceutical and spice markets",
  "Premium varieties with consistent quality and aroma",
  "Suitable for food, pharmaceutical, and dye industry applications",
  "Export-grade quality with reliable supply chain"
]

export default function DryTurmericTable() {
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center justify-center">
          ...
          DRY TURMERIC - Premium Export Quality
        </h2>
        <p className="text-base text-gray-600 max-w-4xl mx-auto">
          Premium quality dry turmeric with high curcumin content, available in multiple varieties 
          and drying methods for diverse industrial and culinary applications.
        </p>
      </div>
