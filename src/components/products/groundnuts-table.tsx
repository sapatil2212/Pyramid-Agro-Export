...
const varieties = [
  {
    name: "Raw Groundnuts",
    type: "Natural",
    characteristics: "Fresh raw groundnuts with high oil content and protein for oil extraction",
    features: "High oil content, Protein rich, Oil extraction, Natural"
  },
  {
    name: "Roasted Groundnuts",
    type: "Processed",
    characteristics: "Premium roasted groundnuts with enhanced flavor and crunch for snacks",
    features: "Enhanced flavor, Crunchy, Snacks, Processed"
  },
  {
    name: "Blanched Groundnuts",
    type: "Processed",
    characteristics: "Skinless blanched groundnuts perfect for confectionery and food processing",
    features: "Skinless, Confectionery, Food processing, Clean"
  }
]

const specifications = [
  { category: "Origin", value: "India" },
  { category: "Forms", value: "Raw, Roasted, Blanched" },
  { category: "Grades", value: "Java, Bold, TJ" },
  { category: "Uses", value: "Snacks, oil extraction, confectionery" },
  { category: "Quality Grade", value: "Export Grade" },
  { category: "Oil Content", value: "High oil content for industrial uses" },
  { category: "Protein", value: "High protein content" },
  { category: "Processing", value: "Available in multiple forms" },
  { category: "Supply Chain", value: "Reliable supply chain for bulk exports" },
  { category: "Markets", value: "Strong demand in Middle East" }
]

const keyAdvantages = [
  "High oil content and protein, perfect for food and industrial uses",
  "Available in multiple grades and forms to suit global buyer requirements",
  "Reliable supply chain for bulk exports to the Middle East",
  "Premium quality groundnuts with consistent grading",
  "Suitable for snacks, oil extraction, and confectionery applications",
  "Strong demand in international markets for quality and reliability"
]

export default function GroundnutsTable() {
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        <h2 className="text-2xl font-bold text-gray-900 mb-3 flex items-center justify-center">
          ...
          GROUNDNUTS (PEANUTS) - Premium Export Quality
        </h2>
        <p className="text-base text-gray-600 max-w-4xl mx-auto">
          Premium quality groundnuts available in multiple forms and grades, 
            ...
            <div className="overflow-x-auto">
              <table className="w-full">
                <thead className="bg-gray-50">
                  <tr>
                    <th className="px-4 py-3 text-left text-xs font-semibold text-gray-900">Form Name</th>
