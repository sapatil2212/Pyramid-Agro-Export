...
export default function DryTurmericPage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-4 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-sm md:text-[15px] text-gray-600 leading-relaxed">
                <p>
                  Experience the finest dry turmeric from India&apos;s premier spice regions. 
                  Our premium quality turmeric varieties are carefully processed, dried, 
                  and exported to meet the highest international standards.
                </p>
                <p>
                  With high curcumin content (2-5%) and available in both sun-dried and mechanically dried forms, 
                  our turmeric is perfect for food, pharmaceutical, and dye industry applications.
                </p>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              Premium quality dry turmeric with high curcumin content and medicinal properties
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Star,
                title: "High Curcumin",
                description: "2-5% curcumin content"
              },
              {
                icon: CheckCircle,
                title: "Multiple Varieties",
                description: "Salem, Nizamabad, Rajapuri"
              },
              {
                icon: Leaf,
                title: "Drying Methods",
                description: "Sun-dried & mechanically dried"
              },
              {
                icon: Truck,
                title: "Pharmaceutical Grade",
                description: "Dubai & UAE markets"
              },
              {
                icon: Shield,
                title: "Multiple Applications",
                description: "Food, pharma, dye industry"
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
      ...
      {/* Interactive Dry Turmeric Table */}
          ...
          >
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Contact us today for the finest quality dry turmeric delivered to your doorstep with our proven export process
              </p>
              <Button
                onClick={() => window.location.href = '/contact'}
                size="lg"
