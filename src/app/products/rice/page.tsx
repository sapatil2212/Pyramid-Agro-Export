          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Experience the finest rice from India&apos;s fertile plains. Our premium quality 
                rice is carefully selected, processed, and packed to ensure the best taste, 
                texture, and nutritional value for your table.
              </p>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality rice with excellent taste and nutritional value
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality rice delivered to your doorstep
            </p>
            <LoadingButton
              onClick={openModal}
              size="lg"
