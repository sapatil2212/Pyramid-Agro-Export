          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                Fresh & Juicy{" "}
                <span className="text-emerald-600">Guava</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Delight in the sweet and tangy taste of our premium guava. 
                Grown in India&apos;s fertile lands and carefully selected for 
                ...
                <div className="relative w-full h-80 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="text-center text-gray-600">
                      ...
                      <p className="text-lg font-semibold">Fresh Guava</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our Guava?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality guava with natural sweetness and freshness
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Perfectly ripe guava with natural sweetness"
              },
              {
                icon: CheckCircle,
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to Order Fresh Guava?
            </h2>
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality guava delivered fresh to you
            </p>
            <Button
              onClick={openModal}
              size="lg"
