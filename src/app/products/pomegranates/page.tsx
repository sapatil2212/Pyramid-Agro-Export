...
export default function PomegranatesPage() {
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-4 items-center">
            ...
            >
              <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-4">
                Premium Quality{" "}
                <span className="text-emerald-600">Pomegranates</span>
              </h1>
              <div className="space-y-4 text-sm md:text-[15px] text-gray-600 leading-relaxed">
                <p>
                  Experience the finest pomegranates from India&apos;s premier orchards. 
                  Our premium quality Bhagwa pomegranates are carefully selected, packed, 
                  and exported to meet the highest international standards.
                </p>
                <p>
                  The Bhagwa variety is globally famous for its deep red arils, high juice content, 
                  and long storage capacity, making it perfect for international markets.
                </p>
              </div>
              ...
              <div className="relative max-w-lg mx-auto">
                ...
                >
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-lg font-semibold">Premium Pomegranates</p>
        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              Why Choose Our Pomegranates?
            </h2>
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              Premium quality pomegranates with exceptional taste and international appeal
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {[
              ...
              },
              {
                ...
                description: "Residue-free & export compliant"
              },
              {
                icon: Leaf,
                title: "Deep Red Arils",
                description: "Bright red, visually appealing"
              },
              {
                icon: Truck,
                title: "Long Storage",
          ...
          >
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                Ready to Order Premium Pomegranates?
              </h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Contact us today for the finest quality Bhagwa pomegranates delivered to your doorstep with our proven export process
              </p>
              <Button
                onClick={() => window.location.href = '/contact'}
                size="lg"
