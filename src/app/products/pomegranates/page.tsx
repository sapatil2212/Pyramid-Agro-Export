          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Experience the finest pomegranates from India&apos;s best orchards. 
                Our premium quality pomegranates are carefully selected, packed, 
                and exported to meet international standards.
              </p>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality pomegranates with international standards
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Hand-picked from the finest orchards in India"
              },
              {
                icon: CheckCircle,
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality pomegranates delivered to your doorstep
            </p>
            <Button
              onClick={openModal}
              size="lg"
