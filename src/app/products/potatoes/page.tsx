          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Enjoy the finest potatoes from India&apos;s fertile soil. Our premium quality 
                potatoes are carefully selected, graded, and packed to ensure the best 
                ...
                <div className="relative w-full h-80 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="text-center text-gray-600">
                      ...
                      <p className="text-lg font-semibold">Fresh Potatoes</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality potatoes with excellent taste and nutritional value
            </p>
          </motion.div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality potatoes delivered to your doorstep
            </p>
            <LoadingButton
              onClick={openModal}
              size="lg"
