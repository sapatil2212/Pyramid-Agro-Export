...
import PotatoesTable from "@/components/products/potatoes-table"
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-4 items-center">
            ...
            >
              <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-4">
                Premium Quality{" "}
                <span className="text-emerald-600">Potatoes</span>
              </h1>
              <div className="space-y-4 text-sm md:text-[15px] text-gray-600 leading-relaxed">
                <p>
                  Experience the finest potatoes from India&apos;s premier potato farms. 
                  Our premium quality potatoes are carefully harvested, graded, 
                  and exported to meet the highest international standards.
                </p>
                <p>
                  Starch-rich, damage-free, and well-graded potatoes perfect for chips, fries, 
                  and culinary cooking with excellent industrial and retail applications.
                </p>
              </div>
              ...
              <div className="relative max-w-lg mx-auto">
                ...
                >
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-lg font-semibold">Premium Potatoes</p>
        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          >
            ...
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              Premium quality potatoes with high dry matter content and excellent cooking properties
            </p>
          </motion.div>
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {[
              {
                icon: Star,
                title: "High Dry Matter",
                description: "Ideal for chips and fries"
              },
              {
                icon: CheckCircle,
                title: "Starch-Rich",
                description: "Perfect for industrial use"
              },
              {
                icon: Leaf,
                title: "Well-Graded",
                description: "Damage-free and uniform"
              },
              {
                icon: Truck,
                title: "Bulk Supply",
                description: "Uniform quality shipments"
              },
              {
                icon: Shield,
                title: "Cooking Quality",
                description: "Popular in Middle East"
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
          ...
          >
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                Ready to Order Premium Potatoes?
              </h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Contact us today for the finest quality potatoes delivered to your doorstep with our proven export process
              </p>
              <Button
                onClick={() => window.location.href = '/contact'}
                size="lg"
