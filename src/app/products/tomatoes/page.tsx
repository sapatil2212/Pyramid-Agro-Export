...
import TomatoesTable from "@/components/products/tomatoes-table"
import { useProductData } from "@/hooks/use-product-data"

export default function TomatoesPage() {
  const { product, loading, refetch } = useProductData('tomatoes')
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-4 items-center">
            ...
            >
              <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-4">
                {product?.heroTitle || "Premium Quality Tomatoes"}
              ...
              <div className="space-y-4 text-sm md:text-[15px] text-gray-600 leading-relaxed">
                {product?.heroDescription ? (
                  ...
                  <>
                    <p>
                      Experience the finest tomatoes from India&apos;s premier sources. 
                      Our premium quality tomatoes are carefully selected, packed, 
                      and exported to meet the highest international standards.
                    </p>
                    <p>
                      Known for their exceptional quality, taste, and freshness, 
                      our tomatoes are perfect for international markets.
                    </p>
                  </>
                )}
              </div>
            ...
            >
              <div className="relative max-w-lg mx-auto">
                <Image
                  src={product?.heroImageUrl || "/products/tomatoes.png"}
                  alt={product?.heroTitle || "Premium Tomatoes"}
                  width={600}
                  height={400}
                ...
                >
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-lg font-semibold">{product?.heroTitle || "Premium Tomatoes"}</p>
        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              {product?.featuresTitle || "Why Choose Our Tomatoes?"}
            </h2>
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              {product?.featuresSubtitle || "Premium quality tomatoes with exceptional taste and freshness"}
            </p>
          </motion.div>
          ...
          >
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                {product?.ctaTitle || "Ready to Order Premium Tomatoes?"}
              </h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                {product?.ctaDescription || "Contact us today for the finest quality tomatoes delivered to your doorstep with our proven export process"}
              </p>
              <Button
