            ...
            {[
              {
                ...
                description: "Hand-picked from the finest vineyards in India"
              },
              {
                icon: CheckCircle,
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            ...
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality grapes delivered to your doorstep
            </p>
            <Button
              onClick={openModal}
              size="lg"
