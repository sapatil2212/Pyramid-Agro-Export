          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                Premium Quality{" "}
                <span className="text-emerald-600">Garlics</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Experience the robust flavor of our premium garlic. Grown in India&apos;s 
                fertile regions and carefully selected for the best quality, aroma, 
                and taste that enhances any culinary creation.
              </p>
                ...
                <div className="relative w-full h-80 rounded-xl overflow-hidden">
                  ...
                  >
                    <div className="text-center text-gray-600">
                      ...
                      <p className="text-lg font-semibold">Premium Garlics</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our Garlics?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality garlic with robust flavor and health benefits
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Star,
                title: "Robust Flavor",
                description: "Carefully selected for optimal aroma and taste"
              },
              {
                icon: CheckCircle,
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to Order Premium Garlics?
            </h2>
