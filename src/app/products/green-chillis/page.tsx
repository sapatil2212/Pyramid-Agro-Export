...
import GreenChillisTable from "@/components/products/green-chillis-table"

export default function GreenChillisPage() {
  ...
  return (
    <div className="min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-4 items-center">
            ...
            >
              <h1 className="text-xl md:text-4xl font-bold text-gray-900 mb-4">
                Premium Quality{" "}
                <span className="text-emerald-600">Green Chili</span>
              </h1>
              <div className="space-y-4 text-sm md:text-[15px] text-gray-600 leading-relaxed">
                <p>
                  Experience the finest green chilies from India&apos;s premier spice regions. 
                  Our premium quality chilies are carefully harvested, processed, 
                  and exported to meet the highest international standards.
                </p>
                <p>
                  Vibrant green chilies with high pungency and packed with nutrients, 
            ...
            >
              <div className="relative max-w-lg mx-auto">
                <img
                  src="/products/green-chillies.png"
                  alt="Premium Green Chilies"
                ...
                >
                  <div className="text-center text-gray-600">
                    ...
                    <p className="text-lg font-semibold">Premium Green Chilies</p>
        ...
        <div className="container mx-auto px-6 sm:px-8">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-3">
              Why Choose Our Green Chilies?
            </h2>
            <p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto">
              Premium quality green chilies with superior spice level and authentic flavors
            </p>
          </motion.div>
            ...
            {[
              {
                icon: Star,
                title: "High Pungency",
                description: "Superior spice level"
              },
              {
                icon: CheckCircle,
                title: "Vibrant Green",
                description: "Fresh and attractive color"
              },
              {
                icon: Leaf,
                title: "Long Shelf Life",
                description: "Longer than other sources"
              },
              {
                icon: Truck,
                title: "Fresh & Dried",
                description: "Both forms available"
              },
              {
                icon: Shield,
                title: "Authentic Flavors",
                description: "Dubai & Oman markets"
              }
            ].map((feature, index) => (
              <motion.div
                key={feature.title}
      ...
      {/* Interactive Green Chilies Table */}
          ...
          >
            <div className="bg-gradient-to-r from-emerald-50 to-blue-50 rounded-2xl p-8 border border-emerald-100">
              <h3 className="text-xl md:text-2xl font-bold text-gray-900 mb-4">
                Ready to Order Premium Green Chilies?
              </h3>
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                Contact us today for the finest quality green chilies delivered to your doorstep with our proven export process
              </p>
              <Button
                onClick={() => window.location.href = '/contact'}
                size="lg"
