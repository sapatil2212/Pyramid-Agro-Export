          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h1 className="text-3xl md:text-5xl font-bold text-gray-900 mb-6">
                Fresh & Spicy{" "}
                <span className="text-emerald-600">Green Chillis</span>
              </h1>
              <p className="text-lg text-gray-600 mb-8 leading-relaxed">
                Experience the perfect heat and flavor of our premium green chillis. 
                Grown in India&apos;s fertile lands and carefully selected for the best 
                quality, freshness, and spice level.
              </p>
            ...
            >
              <div className="bg-gradient-to-br from-emerald-100 to-amber-100 rounded-2xl p-8">
                <div className="relative w-full h-80 rounded-xl overflow-hidden">
                  <img
                    src="/products/green-chillis.jpg"
                    alt="Fresh Green Chillis"
                  ...
                  >
                    <div className="text-center text-gray-600">
                      ...
                      <p className="text-lg font-semibold">Fresh Green Chillis</p>
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
              Why Choose Our Green Chillis?
            </h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Premium quality green chillis with perfect spice and freshness
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description: "Carefully selected for optimal heat and flavor"
              },
              {
                icon: CheckCircle,
        ...
        <div className="container mx-auto px-6 sm:px-8 lg:px-16 xl:px-32">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-4">
              Ready to Order Fresh Green Chillis?
            </h2>
            <p className="text-lg text-emerald-100 mb-8 max-w-2xl mx-auto">
              Contact us today for the finest quality green chillis delivered fresh to you
            </p>
            <LoadingButton
              onClick={openModal}
              size="lg"
